...
import { Card, ListItem, Icon,Input,Avatar } from 'react-native-elements'
    ...
    render() {
        return (
            <ScrollView contentContainerStyle={styles.background}>
               ...
               <View style={{flexDirection:'row',flex:1,width:350,paddingBottom:20,marginLeft:30}}>
               <View style={{height:150,width:150,padding:10,marginLeft:10}} >
               <Avatar
               size={"xlarge"}
...
/>
               ...
               <Card containerStyle={{borderRadius:15,flex:1}}>
                <Text style={{color:themeColor,fontSize:17}}>Medical History:</Text>
                       <View >
 ...
 <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:themeColor,marginVertical:30}}>
         <Button
