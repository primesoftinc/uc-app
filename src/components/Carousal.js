...
const Screen = props => (
  <View style={{ flex: 1, backgroundColor: "blue" }}>
    <Image
      ...
      style={{ width: SCREEN_WIDTH - 10, height: 300, borderRadius: 15 }}
    />
  </View>
);
    ...
    this.state = {
      ...
      list: [
        ...
        },
        {
          id: "sNPnbI1arSE",
          thumbnail:
            "https://image.shutterstock.com/image-photo/smiling-doctor-shaking-hand-patient-600w-1137974861.jpg",
          title: "Eminem - My Name Is"
        },
        {
          id: "VOgFZfRVaww",
          thumbnail:
            "https://image.shutterstock.com/image-photo/attractive-female-doctor-front-medical-600w-557085679.jpg",
          title: "Are You Ready"
        }
      ]
    };
