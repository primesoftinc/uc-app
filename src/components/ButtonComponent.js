...
render() {
   ...
   const { title = 'Enter',buttonColor,iconRight=false, style = {},textColor, textStyle = {},width=325,height=50,loading=false,iconStyle={},onPress,size,type="solid",state ,radius=15,icon} = this.props;
   ...
   return (
    <View>
    {
          ...
          <Button    
            ...
            buttonStyle={[styles.container,sizes[size],{borderRadius:Number(radius)},{backgroundColor:buttonColor},{height:Number(height)},{width:Number(width)},style]}
