...
import {
  MaterialIcons as Person,
  Entypo as Address,
  Foundation as Specialization,
  FontAwesome as HopitalImage,
  FontAwesome as Symptom,
  AntDesign as Prescription,
  Ionicons as TimeSlot,
  MaterialCommunityIcons as Doctor
