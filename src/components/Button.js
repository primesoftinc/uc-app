    ...
    <Button
      icon={
        <Icon
          name="md-mail"
          size={25}
          iconStyle={{ padding: 25, marginRight: 20 }}
        />
      }
      title="Sign in with mail"
      titleStyle={{ padding: 25, marginLeft: 15 }}
      buttonStyle={[
        { backgroundColor: "red" },
        styles.container,
        sizes[size],
      ...
      <View style={{ alignItems: "center", justifyContent: "center" }}>
        {icon == "mail" ? (
          <Button
            ...
            titleStyle={{ padding: 25, marginLeft: 15 }}
            buttonStyle={[
              { backgroundColor: "red", padding: 5, marginLeft: 20 },
              styles.container,
              sizes[size],
              radius1[radius],
              { height: 45 },
        ...
        {icon == "google" && isLoading == false ? (
          ...
          >
            ...
            <View>
              <Text
                style={{ marginLeft: 20, color: "#676868", fontStyle: "bold" }}
              >
                {" "}
                Sign in with Google{" "}
              </Text>
